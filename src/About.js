        ...
        <div className="container py-3">
          <div className="row">
            <div className="col-md-12 col-sm-12 col-xl-12">
              ...
              <p>
                Medi-Van is an online ambulance booking platform to book an
                ...
                Medi-Van ambulance we plan to provide a platform to help you
            ...
            <div className="col-md-12 col-sm-12 col-xl-12">
              <h2 className="heading">Unique Features Of Medi-van</h2><br/>
              <p>
            ...
            <h4>
              Medi-van works like any other taxi booking app like Ola & Uber
              with the same booking structure.
            </h4><br/>
            <p>
              <b>Call ambulance app Benefits Of Medi-van Patients :- </b> Self-Care
            ...
            <p>
             <b> About Medi-Van drivers Web-App :-</b> Medi-van Drivers Web-app allows
              ...
              register to partner with Medi-van to provide the service. Driver
              ...
              required assisstance if any would be provided by Medi-van team.Our
